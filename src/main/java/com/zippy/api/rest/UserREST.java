...
public class UserREST {
    ...
    public ResponseEntity<?> updateUser( @PathVariable ObjectId id,  @Valid @RequestBody updateUserDTO dto) {
    ...
    public ResponseEntity<?> getUser( @NotNull @AuthenticationPrincipal Credential credential, @PathVariable ObjectId id) {
